	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'bold-blue': 'var(--bold-blue)',
				'bold-purple': 'var(--bold-purple)',
				'bold-emerald': 'var(--bold-emerald)',
				'bold-orange': 'var(--bold-orange)',
				'bold-pink': 'var(--bold-pink)',
				'bold-cyan': 'var(--bold-cyan)',
				'accent-bright-blue': 'var(--accent-bright-blue)',
				'accent-bright-green': 'var(--accent-bright-green)',
				'accent-bright-yellow': 'var(--accent-bright-yellow)',
				'accent-bright-purple': 'var(--accent-bright-purple)',
				'accent-bright-pink': 'var(--accent-bright-pink)',
			},
			spacing: {
