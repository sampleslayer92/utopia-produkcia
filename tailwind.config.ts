...
export default {
	...
	theme: {
        ...
        'bold-primary': 'var(--bold-primary)',
        'bold-secondary': 'var(--bold-secondary)', 
        'bold-success': 'var(--bold-success)',
        'bold-warning': 'var(--bold-warning)',
        'bold-info': 'var(--bold-info)',
        'bold-accent': 'var(--bold-accent)',
			},
			spacing: {
