-- Demo data migration with complete business_locations structure
-- Insert merchants
...
-- Insert business locations with complete structure
INSERT INTO public.business_locations (
  ...
  ('aa11aa11-1111-1111-1111-11111111aa11', '11111111-1111-1111-1111-111111111111', gen_random_uuid(), 'Tech Solutions - Hlavná pobočka', true, 'Hlavná 123', 'Bratislava', '81000', 'SK1234567890123456', 'Ján Novák', 'jan.novak@techsolutions.sk', '+421901234567', 'technology', 50000, 45.50, '08:00-18:00', 'year_round', '2024-01-15 10:30:00+02'),
  ('bb22bb22-2222-2222-2222-22222222bb22', '22222222-2222-2222-2222-222222222222', gen_random_uuid(), 'Retail Master - Centrála', true, 'Obchodná 456', 'Košice', '04000', 'SK2345678901234567', 'Mária Svobodová', 'maria.svoboda@retailmaster.sk', '+421902345678', 'retail', 120000, 32.75, '09:00-21:00', 'year_round', '2024-01-20 15:00:00+02'),
  ('bb22bb23-2222-2222-2222-22222222bb23', '22222222-2222-2222-2222-222222222222', gen_random_uuid(), 'Retail Master - Pobočka 2', true, 'Nákupná 789', 'Košice', '04000', 'SK3456789012345678', 'Eva Nováková', 'eva.novakova@retailmaster.sk', '+421912345678', 'retail', 80000, 28.90, '10:00-20:00', 'year_round', '2024-01-20 15:00:00+02'),
  ('cc33cc33-3333-3333-3333-33333333cc33', '33333333-3333-3333-3333-333333333333', gen_random_uuid(), 'Gastro Express - Reštaurácia', true, 'Reštauračná 789', 'Žilina', '01000', 'SK4567890123456789', 'Peter Dvořák', 'peter.dvorak@gastroexpress.sk', '+421903456789', 'food', 75000, 18.50, '11:00-23:00', 'year_round', '2024-02-01 09:45:00+02'),
  ('cc33cc34-3333-3333-3333-33333333cc34', '33333333-3333-3333-3333-333333333333', gen_random_uuid(), 'Gastro Express - Kaviareň', true, 'Káviarna 456', 'Žilina', '01000', 'SK5678901234567890', 'Lucia Kávová', 'lucia.kavova@gastroexpress.sk', '+421913456789', 'food', 45000, 8.75, '07:00-19:00', 'year_round', '2024-02-01 09:45:00+02'),
  ...
  ('ee55ee55-5555-5555-5555-55555555ee55', '55555555-5555-5555-5555-555555555555', gen_random_uuid(), 'Auto Service Plus - Servis', false, 'Servisná 654', 'Prešov', '08000', 'SK7890123456789012', 'Milan Rychlý', 'milan.rychly@autoserviceplus.sk', '+421905678901', 'automotive', 110000, 250.00, '07:30-17:00', 'year_round', '2024-02-15 11:50:00+02'),
  ('ff66ff66-6666-6666-6666-66666666ff66', '66666666-6666-6666-6666-666666666666', gen_random_uuid(), 'Beauty Salon Luxe - Salón', true, 'Krásna 987', 'Banská Bystrica', '97400', 'SK8901234567890123', 'Zuzana Krásna', 'zuzana.krasna@beautysalonluxe.sk', '+421906789012', 'beauty', 65000, 42.80, '09:00-20:00', 'year_round', '2024-02-20 13:40:00+02');
