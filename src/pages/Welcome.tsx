...
import { Users, Building2, User, ArrowRight, UserCheck, LogIn, Brain } from "lucide-react";
          ...
          >
            <CardContent className="p-8">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  <h2 className="text-xl font-semibold text-slate-900 mb-1">Research Lab</h2>
                  <p className="text-slate-600">
                    AI výskumný asistent pre pokročilé analýzy
                  </p>
                </div>
