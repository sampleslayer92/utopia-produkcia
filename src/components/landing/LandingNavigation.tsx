      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            />
            <span className="text-2xl font-bold text-gray-900">UTOPIA</span>
          </div>
          ...
          <div className="flex items-center gap-4">
            <Button
              ...
              variant="ghost"
              className="text-gray-600 hover:text-utopia-500 font-medium"
            >
              Prihlásiť sa
            </Button>
            <Button
              onClick={handleOnboardingClick}
              className="bg-blue-gradient text-white px-6 py-2 rounded-xl font-medium hover:shadow-lg transition-all duration-300"
            >
              Začať
            </Button>
          </div>
