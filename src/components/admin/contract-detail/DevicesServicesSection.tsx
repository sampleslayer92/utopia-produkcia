...
import AddDeviceServiceModal from "./AddDeviceServiceModal";
        ...
        <CardContent className="space-y-6">
          {devices.length > 0 ? (
            devices.map((device: any, index: number) => {
              ...
              return (
                <EditableSection key={device.id || index} isEditMode={isEditMode}>
                        ...
                        <div className="p-4 bg-white rounded-lg border border-slate-200">
                          ...
                          <div className="space-y-2 text-sm">
                            ...
                            <div className="border-t border-slate-200 pt-2 mt-2">
                              ...
                              <div className={`flex justify-between font-bold ${margin < 0 ? 'text-red-600' : 'text-blue-600'}`}>
                                <span>Marža:</span>
